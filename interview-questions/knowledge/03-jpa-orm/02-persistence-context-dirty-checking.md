...
[flush 시점과 쓰기 지연 SQL 실행 순서](15-flush-timing-and-sql-ordering.md)에서 다룬다.
...
(`01-java-kotlin/32-bigdecimal-equals-compareto.md`). 그런데 **Hibernate는 이
...
[벌크 연산과 영속성 컨텍스트](11-bulk-operation-persistence-context.md)에 별도로 정리돼 있다.
