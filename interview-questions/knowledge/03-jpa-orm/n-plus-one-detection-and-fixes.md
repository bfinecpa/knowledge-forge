...
[eager-vs-lazy-fetch-strategy.md](eager-vs-lazy-fetch-strategy.md) §3에 상세히
...
[eager-vs-lazy-fetch-strategy.md](eager-vs-lazy-fetch-strategy.md) §4-3에 있다.
...
적은 것 자체가 EAGER 선언**이다([eager-vs-lazy-fetch-strategy.md](eager-vs-lazy-fetch-strategy.md)
§2). 이걸 빌드에서 실패시킨다.
