...
[영속성 컨텍스트와 변경 감지](02-persistence-context-dirty-checking.md) 참고.)
...
PATCH 용도로는 쓸 수 없다 —
[merge vs 변경 감지](05-merge-vs-dirty-checking.md) 참고.
...
(같은 논리가 [OSIV 트레이드오프](09-osiv-tradeoff-and-migration.md)에도 그대로 나온다 —
