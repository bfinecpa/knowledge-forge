...
규칙)는 [transactional-default-behavior-rollback.md](../02-spring/transactional-default-behavior-rollback.md),
이벤트 리스너가 트랜잭션 phase에 어떻게 묶이고 커밋 뒤 실패에 롤백이
없다는 사실은 [spring-event-transactional-event-listener.md](../02-spring/spring-event-transactional-event-listener.md)
...
대가는 [long-transaction-harm-and-shortening.md](./long-transaction-harm-and-shortening.md)
...
[long-transaction-harm-and-shortening.md](./long-transaction-harm-and-shortening.md)
§2 참고).
...
(iii)은 [spring-event-transactional-event-listener.md](../02-spring/spring-event-transactional-event-listener.md)
