...
고정하는 패턴은 [`../03-jpa-orm/14-unique-constraint-concurrent-insert.md`](../03-jpa-orm/14-unique-constraint-concurrent-insert.md)의
"DB가 마지막 심판"과 같은 뿌리다.
...
그대로 남는다([`../03-jpa-orm/23-read-replica-routing-and-lag.md`](../03-jpa-orm/23-read-replica-routing-and-lag.md)
