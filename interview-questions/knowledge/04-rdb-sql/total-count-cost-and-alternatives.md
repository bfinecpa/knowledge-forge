...
> **역할 구분**: 같은 섹션의 깊은 페이지네이션 문서(`deep-pagination-offset-vs-cursor.md`)는 `LIMIT 100000, 20`의
...
클러스터드 vs 세컨더리 문서(`clustered-vs-secondary-index.md`)와 커버링 인덱스
문서(`covering-index.md`)의 구조를 그대로 가져온다. 판매자 42의 주문이
